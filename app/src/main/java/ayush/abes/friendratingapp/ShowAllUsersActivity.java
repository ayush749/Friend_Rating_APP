package ayush.abes.friendratingapp;
...
import ayush.abes.friendratingapp.APIClasses.JusSayAPIClient;
import ayush.abes.friendratingapp.APIClasses.ShowAllUsersList;
import ayush.abes.friendratingapp.APIClasses.ShowMyUsersLists;
...
// fetching all users list
        ...
        show_my_ratings_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ShowAllUsersActivity.this,ShowMyRatingActivity.class);
