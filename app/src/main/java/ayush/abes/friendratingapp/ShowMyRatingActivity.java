...
import ayush.abes.friendratingapp.APIClasses.ShowRatings;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class ShowMyRatingActivity extends AppCompatActivity implements Callback<ShowRatings> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_my_rating);
